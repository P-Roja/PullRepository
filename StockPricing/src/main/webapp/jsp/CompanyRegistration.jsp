<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1"   import="java.util.*,com.StockPricing.model.Sector" %>
			...
			<form:form action="registerCompany" method="post"
				...
				<tr>
					...
					<td><form:input name="" class="form-control" placeholder="CEO"
							type="text" path="ceo" required="required" /> <small><form:errors
								path="ceo" cssClass="errormsg" /></small></td>
				</tr>
				<tr>
					<td>Board Of Directors</td>
					<td><form:input name="" class="form-control"
							placeholder="Board Of directors" type="text"
				...
				<tr>
					<td>TurnOver</td>
					<td><form:input name="" class="form-control"
							placeholder="Turn Over" type="text" path="turnover"
							required="required" /> <small><form:errors
				...
				<%
					...
					<td>Sector Id</td>
					<td><form:select path="sector" class="form-control"
				...
				<tr>
					...
					<td><form:input name="" class="form-control"
							placeholder="Brief WriteUp" type="text" path="writeUp"
							required="required" /> <small><form:errors
				...
				<tr>
					<td></td>
					<td>
						<button type="submit" id="registerCompany" class="btn btn-project"
							name="registerCompany">Register</button>
						</button>
					</td>
				</tr>
			</form:form>
